...
*/
    for(i=0;i<15;i++)
    {
        for(j=0;j<75;j++)
        {
            ...
            else if (j>43-i&&j<38 || j>47&&j<42+i||j>37&&j<48&&i==14||i<8&&j>43-i&&j<42+i)
            {
                printf(" ");
            }
     ...
     for(i=0;i<20;i++)
      ...
      for(i=0;i<7;i++)
      {
          for(j=0;j<78;j++)
          {
              ...
              else if (j==26&&i==0||j==58&&i==0||j==26&&i==5||j==58&&i==5||j==26&&i==6||j==58&&i==6)
              {
                  printf("|");
              }
              else if (j==27&&i==1||j==59&&i==1||j==28&&i==2||j==60&&i==2)
              {
                  printf("\\");
              }
              else if (j==28&&i==3||j==27&&i==4||j==60&&i==3||j==59&&i==4)
              {
                  printf("/");
              }
              else if (i==0&&j>26&&j<58||i==1&&j<59&&j>27||i==2&&j<60&&j>28||i==3&&j<60&&j>28||i==4&&j<59&&j>27||i==5&&j>26&&j<58||i==6&&j>26&&j<58)
              {
                  printf(".");
              }
              else
